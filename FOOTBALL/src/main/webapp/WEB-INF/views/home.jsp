...
function searchMatches() {
	var param = {
		...
		'today':$('#changeDate').val()
	};
	
	$.ajax({
		type: 'post',
		dataType: 'text',
		url: '${contextPath}/matches/todayMatches.do',
		data: param,
...
<body>
	...
	<header class="py-4 bg-dark">
		<div class="container px-lg-5">
			<div class="text-white" style="height:30px;">
				<div class="float-start text-center leagueId" style="width:25%;" data-id="2021">Premier League</div>
				<div class="float-start text-center leagueId" style="width:25%;" data-id="2014">La Liga</div>
				<div class="float-start text-center leagueId" style="width:25%;" data-id="2002">Bundesliga</div>
				<div class="float-start text-center leagueId" style="width:25%;" data-id="2019">Serie A</div>
    ...
    <section class="bg-white">
    	<div class="container py-4 px-lg-5">
			<div class="date-area text-black">
				...
				<span class="date-num" data-dt>08/23</span>
				<span class="date-num">08/23</span>
				<span class="date-num fw-bold">08/23</span>
				<span class="date-num">08/23</span>
				<span class="date-num">08/23</span>
